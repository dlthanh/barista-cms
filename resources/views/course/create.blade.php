...
@section('title', 'Thêm mới lịch khai giảng')

@section('main-title', 'Thêm mới lịch khai giảng')
    ...
    <form action="" method="POST" class="ui form" accept="image/*" enctype="multipart/form-data">
        ...
        <div class="two fields">
            <div class="required field">
                <label>Ngày</label>
                <input type="number" name="date" placeholder="Ngày" min="1" max="31" required value="{{old('date')}}">
            </div>
            ...
            <div class="required field">
                <label>Năm</label>
                <input type="number" name="year" placeholder="Năm" min="2019" required value="{{old('year')}}">
            </div>
        </div>

        <div class="required field">
            <label>Nội dung khóa học</label>
            <input type="text" name="label" placeholder="Nội dung" required value="{{old('label')}}">
        </div>
